...
import { mudarFavorito, mudarItem, deletarItem } from 'store/reducers/itens';
...
function Item(props) {
    ...
    const estaNoCarrinho = useSelector(
        state => state.carrinho.some(
            ...
            <div className={styles['item-descricao']}>
                ...
                <div className={styles['item-info']}>
                    ...
                    <div className={styles['item-acoes']}>
                        ...
                        {carrinho
                            ?
                                (<div classNames={styles.quantidade}>
                                    Quantidade: 
                                    <AiFillMinusCircle 
                                        {...quantidadeProps} 
                                        onClick={() => {
